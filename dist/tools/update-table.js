...
export function registerUpdateTable(server, ctx) {
    server.registerTool('update_table', {
        ...
        const table = await ctx.airtableService.updateTable(args.baseId, args.tableId, { name: args.name, description: args.description });
