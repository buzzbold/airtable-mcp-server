...
export function registerListComments(server, ctx) {
    server.registerTool('list_comments', {
        ...
        const response = await ctx.airtableService.listComments(args.baseId, args.tableId, args.recordId, args.pageSize, args.offset);
