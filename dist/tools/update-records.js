...
export function registerUpdateRecords(server, ctx) {
    server.registerTool('update_records', {
        ...
        const records = await ctx.airtableService.updateRecords(args.baseId, args.tableId, args.records.map((r) => ({ id: r.id, fields: r.fields })));
