...
export function registerSearchRecords(server, ctx) {
    server.registerTool('search_records', {
        ...
        const records = await ctx.airtableService.searchRecords(args.baseId, args.tableId, args.searchTerm, args.fieldIds, args.maxRecords, args.view);
